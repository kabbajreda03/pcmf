...
protected:
	...
	models::UnderlyingModel & underlying_model;
	options::Option &option;
	const unsigned long sample_number;
	const double t;
	MonteCarloRoutine(models::UnderlyingModel & underlying_model, options::Option &option, const unsigned long sample_number, const double t) : 
...
public:
	MonteCarloRoutineAtOrigin(models::UnderlyingModel &underlying_model, options::Option &option, const unsigned long sample_nb, const PnlVect * const spots) :
...
public:
	MonteCarloRoutineAtTimeT(models::UnderlyingModel &underlying_model, options::Option &option, const unsigned long sample_nb, const PnlMat * const past, const double t) :
