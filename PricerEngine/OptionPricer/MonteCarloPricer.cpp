...
void MonteCarloPricer::price_at(const double time, models::UnderlyingModel & underlying_model, options::Option &option, PnlMat * past, double &price, double &confidence_interval) const
{
